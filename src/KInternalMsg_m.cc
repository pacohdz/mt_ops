...
KRegisterAppMsg::KRegisterAppMsg(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
}
...
KNeighbourListMsg::KNeighbourListMsg(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
