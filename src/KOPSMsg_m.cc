...
int KDataMsgDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='h' && strcmp(fieldName, "hopsTravelled")==0) return base+8;
    if (fieldName[0]=='o' && strcmp(fieldName, "originatorNodeName")==0) return base+9;
    if (fieldName[0]=='f' && strcmp(fieldName, "finalDestinationNodeName")==0) return base+10;
    if (fieldName[0]=='d' && strcmp(fieldName, "destinationOriented")==0) return base+11;
    if (fieldName[0]=='g' && strcmp(fieldName, "goodnessValue")==0) return base+12;
    if (fieldName[0]=='m' && strcmp(fieldName, "messageID")==0) return base+13;
    if (fieldName[0]=='h' && strcmp(fieldName, "hopCount")==0) return base+14;
...
std::string KDataMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 8: return long2string(pp->getHopsTravelled());
        case 9: return oppstring2string(pp->getOriginatorNodeName());
        case 10: return oppstring2string(pp->getFinalDestinationNodeName());
        case 11: return bool2string(pp->getDestinationOriented());
        case 12: return long2string(pp->getGoodnessValue());
        case 13: return oppstring2string(pp->getMessageID());
        case 14: return long2string(pp->getHopCount());
        default: return "";
    }
}
...
bool KDataMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 8: pp->setHopsTravelled(string2long(value)); return true;
        case 9: pp->setOriginatorNodeName((value)); return true;
        case 10: pp->setFinalDestinationNodeName((value)); return true;
        case 11: pp->setDestinationOriented(string2bool(value)); return true;
        case 12: pp->setGoodnessValue(string2long(value)); return true;
        case 13: pp->setMessageID((value)); return true;
        case 14: pp->setHopCount(string2long(value)); return true;
